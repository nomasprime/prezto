...
To configure the format of the [git-log][8] and [git-reflog][15] output, add the following to
...
```sh
zstyle ':prezto:module:git:reflog:context' format '<context>'
```
...
[15]: http://www.kernel.org/pub/software/scm/git/docs/git-reflog.html
